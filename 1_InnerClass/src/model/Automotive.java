...
public class Automotive implements Serializable { 
	 ...
	 */
	public Automotive(String n, float bPrice, int optionSetsize) {		
		name = n;
		baseprice = bPrice;
	...
	public void deleteOpSet(String n) {
		for (int i = 0; i < opset.length; ++i) {
			if (opset[i].getOpsetName() == n) {
				// i became the removed elem index
				opset[i] = null;
			}
		}
	}
	...
	public void updateOpset(String n, OptionSet newOpset) {
		for (int i = 0; i < opset.length; ++i) {
			if (opset[i].getOpsetName() == n) {
				// i became the updated elem index
				opset[i] = newOpset;
			}
		}
	}
	...
	public void updateOpsetName(String oldName, String newName) {
		for (int i = 0; i < opset.length; ++i) {
			if (opset[i].getOpsetName() == oldName) {
				// i became the found elem index
